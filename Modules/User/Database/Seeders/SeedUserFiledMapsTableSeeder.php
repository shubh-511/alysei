...
class SeedUserFiledMapsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = array(
                        ...
                        array("user_field_id"=>"32",'option_id'=>'601','role_id'=>'10'),
                        array("user_field_id"=>"32",'option_id'=>'601','role_id'=>'3'),
                        array("user_field_id"=>"32",'option_id'=>'601','role_id'=>'6'),
                        array("user_field_id"=>"32",'option_id'=>'601','role_id'=>'7'),
                        array("user_field_id"=>"32",'option_id'=>'601','role_id'=>'8'),
                        array("user_field_id"=>"32",'option_id'=>'601','role_id'=>'9'),
                    );
