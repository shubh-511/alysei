...
class SeedRolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = array(
                        ...
                        array("type" => "member","name"=>"Italian F&B Producers",'slug'=>'Italian_F_and_B_Producers','display_name'=>'Producer','description' => 'Alysei certified Producers will be able to explore, find and connect with certified Importers and Distributors in the USA, build up and consolidate their brand, promote their products, and reach their target customers faster to gain visibility and traction in the USA market.','order'=>3),
