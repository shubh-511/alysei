...
class SeedRolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = array(
                        ...
                        array("type" => "member","name"=>"Voice Of Experts",'slug'=>'voice_of_expert','display_name'=>'Voice Of Experts','description' => 'Chefs, Cooking Schools, and all Italian Food and Beverage specialists  will leverage on the Alysei platform to promote their name, brand, offering, events, blogs.','order'=>6),
                        array("type" => "member","name"=>"Travel Agencies",'slug'=>'travel_agencies','display_name'=>'Travel Agencies','description' => 'Strength connection with certified Italian Producers, Importers and Distributors in USA, Voice of Experts, grown your visibility, reach your target customers.','order'=>5),
