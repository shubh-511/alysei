...
class User extends Authenticatable
{
    ...
    protected $fillable = ['email','password','first_name','last_name','name','otp','role_id',"timezone","locale","account_enabled","vat_no","company_name","restaurant_name","country_id","state","phone","country_code","lattitude","longitude","address"];
